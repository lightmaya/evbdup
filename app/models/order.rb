...
class Order < ActiveRecord::Base
  ...
  def self.xml(order=nil, current_u='', options={})
    ...
    dep_s_tmp = order.try(:yw_type) == 'ddcg' ? %Q{ hint='粮机设备必须从入围项目中选择' class='tree_radio required' json_url='/kobe/shared/item_dep_json' json_params='{"otherchoose":"从非入围供应商采购"}' partner='seller_id' } : " display='readonly'"
