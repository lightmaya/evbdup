...
class BidProject < ActiveRecord::Base
  ...
  def self.tips
    %w(1、未指定入围供应商的网上竞价时间不得少于三个工作日。
    2、选择的品目与实际采购物品不符的，一律审核不通过。例如品目选择“网络设备”，实际采购计算机或其他设备的。
    3、不得对供应商提出地域性限制要求，不得故意设置不合理的条件排斥其他供应商，例如“本地供应商，一小时内上门”等。产品的质保、维保必须由供应商承担的，可以要求供应商提供本地销售或售后服务网点证明。
    4、报价供应商不足三家或者最低报价超预算的应当废标。)
  end
